...
.. |textiling01| image:: ../img/operation_texture01.png
.. |textiling02| image:: ../img/operation_texture02.png
...
:テクスチャのタイリング:
    XとYでタイルのように配置する数を指定します。数が多いとその分同じテクスチャが連続で配置されます。
